<div class="actions col-md-2">
	...
	<ul class="side-nav">
		...
		<li><?= $this->Form->postLink(__('Delete Batsman'), ['action' => 'delete', $batsman->id], ['confirm' => __('Are you sure you want to delete # {0}?', $batsman->id)]) ?> </li>
...
<div class="batsmen view col-md-10">
	...
	<div class="row">
		<div class="large-5 columns strings">
			...
			<p><?= $batsman->has('player') ? $this->Html->link($batsman->player->FullName, ['controller' => 'Players', 'action' => 'view', $batsman->player->id]) : '' ?></p>
