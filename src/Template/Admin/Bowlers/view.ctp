<div class="actions col-md-2">
	...
	<ul class="side-nav">
		...
		<li><?= $this->Form->postLink(__('Delete Bowler'), ['action' => 'delete', $bowler->id], ['confirm' => __('Are you sure you want to delete # {0}?', $bowler->id)]) ?> </li>
...
<div class="bowlers view col-md-10">
	...
	<div class="row">
		<div class="large-5 columns strings">
			...
			<p><?= $bowler->has('player') ? $this->Html->link($bowler->player->FullName, ['controller' => 'Players', 'action' => 'view', $bowler->player->id]) : '' ?></p>
